...
oracle_source = os.path.join(ROOT_PATH, 'Redshift_BE_CSA01V2_QUARTERLY_05042024.csv')
datacloud_target = os.path.join(ROOT_PATH, 'S3_BE_CSA01V2_QUARTERLY_05042024.csv')
